...
@interface SAVR_ImgurFluxLoaderTest : XCTestCase
{
    SAVR_ImgurFluxLoader* fluxLoader;
}
@end

@implementation SAVR_ImgurFluxLoaderTest

- (void)setUp
{
    // Put setup code here. This method is called before the invocation of each test method in the class.
    [super setUp];
    fluxLoader = [[SAVR_ImgurFluxLoader alloc] init];
